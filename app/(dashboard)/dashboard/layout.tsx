...
const DashboardLayout = async ({ children }: { children: React.ReactNode }) => {
  ...
  return (
    <div className="w-full flex h-screen">
      ...
      <div
        className="
        hidden md:flex h-full w-full max-w-xs grow flex-col gap-y-5 
                  ...
                  return (
                    <li key={option.id}>
                      ...
                      >
                        <span
                          className="
                            text-gray-400 border-gray-200 group-hover:border-indigo-600 
                            group-hover:text-indigo-600 flex h-6 w-6 shrink-0 items-center justify-center 
